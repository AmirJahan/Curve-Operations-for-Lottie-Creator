 ...
 *
 */
declare type Asset = Scene | Image | FontAsset;
 ...
 *
 */
declare type ExportFormat = 'LOTTIE_JSON';
 ...
 *
 */
declare type Layer = ShapeLayer | SceneLayer | TextLayer | ImageLayer;
...
declare interface Scene extends BaseAssetMixin {
   ...
   *
   * @param opts - Options for importing the animation or image
   * @returns The imported scene layer
   */
 ...
 *
 * @remarks
 * Provides type guards for narrowing unknown values into {@link Layer} or
 * {@link Shape} unions. Useful when iterating over collections of mixed nodes
 * (e.g. `creator.selection.nodes`).
 */
